...
/*	@Test(priority = 20, enabled = true)
	...
	/**
	 * As part of variant C rollout (https://jira.weather.com:8443/browse/IOSFLAG-7692) amazon  calls for feed2, feed3, feed4, hourly details ...etc are suppreessed
	 * hence rather verifying  the presence of individuals checking for aax call presence.  individual  verification to be done in regression and smoke suites
	 * @throws Exception
	 */
